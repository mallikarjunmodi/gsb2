export const homeContent = {
  hero: {
    title: "Shaping a Better Future, Together",
    subtitle: "Global Shapers Bengaluru II Hub",
    description: "A dynamic hub of young changemakers committed to creating real impact.",
    ...
    imageAlt: "Global Shapers working together"
  },
  about: {
    title: "About Us",
    description: [
